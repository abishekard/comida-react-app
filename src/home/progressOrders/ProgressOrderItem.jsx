...
const ProgressOrderItem = (props) => {
  const orderItemClickHandler = (event) => {
    props.onOrderItemClick(props.id);
  };
  const dispatchOrderHandler = (event) => {
    event.stopPropagation();
    props.onDispatchClick(props.id);
  };
  return (
    <div
      ...
      <div className={classes.data_container}>
        ...
        <div className={classes.description}>
          ...
          <div className={classes.price_and_button_div}>
            ...
            <button onClick={dispatchOrderHandler}>dispatch Order</button>
          </div>
        </div>
      </div>
    </div>
...
export default ProgressOrderItem;
